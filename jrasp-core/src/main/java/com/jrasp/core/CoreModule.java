...
import com.jrasp.core.manager.impl.RaspClassFileTransformer;
...
public class CoreModule {
    ...
    // 模块的类转换器
    private final Set<RaspClassFileTransformer> raspClassFileTransformers
            = new LinkedHashSet<RaspClassFileTransformer>();
    ...
    public Set<RaspClassFileTransformer> getRaspClassFileTransformers() {
        return raspClassFileTransformers;
    }
    ...
    public int cCnt() {
        int cCnt = 0;
        for (final RaspClassFileTransformer raspClassFileTransformer : raspClassFileTransformers) {
