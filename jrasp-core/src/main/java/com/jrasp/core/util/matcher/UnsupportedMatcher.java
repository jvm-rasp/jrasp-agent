...
import com.jrasp.core.util.matcher.structure.Access;
...
public class UnsupportedMatcher implements Matcher {
     ...
     */
    private boolean isRaspClass(final ClassStructure classStructure) {
        return classStructure.getJavaClassName().startsWith("com..");
    }
